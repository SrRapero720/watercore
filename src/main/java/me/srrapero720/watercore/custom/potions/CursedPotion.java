...
public class CursedPotion extends Potion {
    public CursedPotion(int t, int l) {
        super(new MobEffectInstance(MobEffects.MOVEMENT_SLOWDOWN, t * l, 3, false, false),
                new MobEffectInstance(MobEffects.BAD_OMEN, t * l, 1, false, false),
                new MobEffectInstance(MobEffects.UNLUCK, t * l, 255, false, false),
                new MobEffectInstance(MobEffects.WEAKNESS, t * l, 1, false, false),
                ...
                new MobEffectInstance(MobEffects.GLOWING, t * l, 255, false, false),
