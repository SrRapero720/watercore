...
public class LanguageSelectScreen extends OptionsSubScreen {
    ...
    @OnlyIn(Dist.CLIENT)
    class LanguageSelectionList extends ObjectSelectionList<LanguageSelectionList.Entry> {
        ...
        public class Entry extends ObjectSelectionList.Entry<LanguageSelectScreen.LanguageSelectionList.Entry> {
            ...
            public void render(PoseStack p_96126_, int p_96127_, int p_96128_, int p_96129_, int p_96130_, int p_96131_, int p_96132_, int p_96133_, boolean p_96134_, float p_96135_) {
                ...
                LanguageSelectScreen.this.font.drawShadow(p_96126_, s, (float)(LanguageSelectScreen.LanguageSelectionList.this.width / 2 - LanguageSelectScreen.this.font.width(s) / 2), (float)(p_96128_ + 1), 16777215, true);
            }
